...
- **v0.6.0: IP + nombre + MAC + fabricante + detección de sistema operativo (TTL) + escaneo de puertos,`scripts/ScanRed_v0.6.ps1`
- **v0.7.0**: se añadió validación de ip y mac, `scripts/ScanRed_v0.7.ps1`
